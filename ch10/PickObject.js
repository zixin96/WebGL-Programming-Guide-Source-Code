...
function main() {
  ...
  canvas.onmousedown = function(ev) {   // Mouse is pressed
    ...
    if (rect.left <= x && x < rect.right && rect.top <= y && y < rect.bottom) {
      ...
      var x_in_canvas_lower_left_origin = x - rect.left, y_in_canvas_lower_left_origin = rect.bottom - y;
      var picked = check(gl, n, x_in_canvas_lower_left_origin, y_in_canvas_lower_left_origin, currentAngle, u_Clicked, viewProjMatrix, u_MvpMatrix);
